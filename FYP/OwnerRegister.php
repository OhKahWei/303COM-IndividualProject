...
<html lang="en" dir="ltr">
   <head>
      <meta charset="utf-8">
      <title> Owner Register | Catch a Ride </title>
   ...
   <?php 
	...
	?>
      ...
      <div class="bg-imgOwnerRegister">
         <div class="content">
            <header>Owner Register Form</header>
		...
		if(isset($_POST["register"]))
		{
			...
			else
			{
					...
					else
					{
						...
						$result1 = mysqli_query($conn, "SELECT OwnerEmail FROM owner WHERE OwnerEmail='".$email."' ");
						...
						else
						{
							...
							$sql = "INSERT INTO owner(OwnerName, OwnerPassword, OwnerPhoneNumber, OwnerIC, OwnerEmail) VALUES ('$name','$password','$phone','$ic','$email')";
							
							if(mysqli_query($conn, $sql))
							{
								echo"<script> alert('Thanks for joining us!');
												window.location=\"ownerlogin.php\";
									 </script>";
							}
							else
							{
