...
<html lang="en" dir="ltr">
   <head>
      <meta charset="utf-8">
      <title> Edit Vehicle | Catch a Ride </title>
...
{			
			...
			$status = $_POST['status'];
					...
					{ 
						...
						{ 
							...
							$sql2 = "UPDATE vehicle SET vehicleName = '$vehicleName', vehiclePrice = '$vehiclePrice', vehicleType = '$vehicleType', vehicleSeat = '$vehicleSeat', vehiclePic = '$image',  vehicleTrans = '$vehicleTrans', vehicleHP = '$vehicleHP', vehicleMileage = '$vehicleMileage', vehicleFuel = '$vehicleFuel', vehicleLuggage = '$vehicleLuggage', vehicleBluetooth = '$vehicleBluetooth', vehicleGrant = '$targetFilePath', vehicleCategory = '$vehicleCategory', status = '$status' WHERE vehicleID = '$ID'";
		...
		if(isset($_SESSION['OwnerID']))
		{
			...
			$result1 = mysqli_query($conn, "SELECT * FROM vehicle WHERE vehicleID='".$ID."' ");
		...
		?>	
			...
			<div class="field">
				...
				<input type="text" name="car"  value="<?php echo $row['vehicleName']?>" >
			</div>
			<div class="field space">
				<span class="fa fa-money"></span>
				<input type="number" name="carPrice"   value="<?php echo $row['vehiclePrice']?>" >
			</div>
			<div class="field space">
				<span class="fa fa-car"></span>
               ...
               <div class="field space">
                  ...
                  <input type="number" name="seat" value="<?php echo $row['vehicleSeat']?>" >
               </div>
			<div class="field space">
			...
			<div class="field space">
				...
				<select name="trans" id="trans" required>
					<option value="<?php echo $row['vehicleTrans']?>" ><?php echo $row['vehicleTrans']?></option>
			   ...
			   <div class="field space">
				...
				<input type="number" name="carHP"   value="<?php echo $row['vehicleHP']?>" >
				</div>
			   <div class="field space">
				<span class="fa fa-tachometer"></span>
				<input type="number" name="carMileage"   value="<?php echo $row['vehicleMileage']?>" >
				</div>
				<div class="field space">
				<span class="fas fa-gas-pump"></span>
				<input type="number" name="carFuel"   value="<?php echo $row['vehicleFuel']?>" >
				</div>
				<div class="field space">
					<span class="fa fa-suitcase"></span>
					<input type="number" name="carluggage"   value="<?php echo $row['vehicleLuggage']?>" >
				</div>
				<div class="field space">
					<span class="fa fa-bluetooth"></span>
					<select name="bluetooth" id="bluetooth" required>
						<option value="<?php echo $row['vehicleBluetooth']?>" ><?php echo $row['vehicleBluetooth']?></option>
				...
				<div class="field space">
					...
					<select name="category" id="category" required>
						<option value="<?php echo $row['vehicleCategory']?>" ><?php echo $row['vehicleCategory']?></option>
